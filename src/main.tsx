...
// Dev-only test utilities for debugging the results screen
if (import.meta.env.DEV) {
  // Debug function to test animated results screen
  // Usage: testResults() or testResults({ playerCount: 3, wordCount: 15 })
  (window as unknown as { testResults: (options?: { playerCount?: number; wordCount?: number }) => void }).testResults = (options = {}) => {
